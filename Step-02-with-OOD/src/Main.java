...
public class Main {
    public static void main(String[] args){
        ...
        PaymentProcessor paymentProcessor = PaymentProcessor.defaultProcessor();
        NotificationDispatcher notificationDispatcher = NotificationDispatcher.defaultDispatcher();
        PricingService pricingService = new CityBasedPricingService();

        ReservationService service = new ReservationService(paymentProcessor, notificationDispatcher, pricingService);
